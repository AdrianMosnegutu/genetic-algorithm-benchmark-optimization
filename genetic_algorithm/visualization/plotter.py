...
class Plotter:
    ...
    def visualize_functions(functions_info: Dict[str, Dict[str, Any]]) -> None:
        ...
        for idx, (func_name, func_info) in enumerate(functions_info.items()):
            ...
            ax_contour.plot(func_info['global_min'][0], func_info['global_min'][1], 'r*', markersize=10, label='Global Min')
            ax_contour.legend()
    ...
    @staticmethod
    def plot_results(results: Dict[str, Dict[str, Dict[str, Any]]], functions_info: Dict[str, Dict[str, Any]]) -> None:
